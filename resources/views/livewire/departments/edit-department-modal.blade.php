<div class="modal fade" wire:ignore.self id="editDepartmentModal">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-">
        <div class="modal-content">
                                    ...
                                    <select wire:model.debounce="manager" wire:ignore class="form-control"
                                        ...
                                        @foreach ($employeeList as $employee)
                                            <option value="{{ $employee->id }}" @php
                                                echo $employee->id == $departments->manager_id ? 'selected' : '';
                                            @endphp>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="addDepartmentButton" class="btn bg-gradient-primary"
