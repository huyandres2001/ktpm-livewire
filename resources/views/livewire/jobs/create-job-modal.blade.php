<div class="col-md-6">
    <!-- Modal -->
    <div class="modal fade bd-example-modal-lg" wire:ignore.self id="createJobModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="addjobsButton" class="btn bg-gradient-primary" wire:click="store">Create
                    </button>
                </div>
            </div>
        </div>
